...
// nr - zmienna okrelaj¹ca numer znaku (dostêpnych jest 8)  od 0 - 7.
// znak[] - okrela kszta³t znaku.. przyk³adowo uint8_t serduszko[] = {4, 10, 17, 23, 23, 17, 31, 0}; definiuje wygl¹d serca.
...
uint8_t LCD_Lightness(uint8_t light_value)	{


	DDRB |= (1<<PB7);		//pin_13_PWM
